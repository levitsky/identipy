...
def run():
    ...
    parser.add_argument('-noremprec',  help='do not remove precursor', action='store_true')
    parser.add_argument('-outallcandidates',  help='output all candidates', action='store_true')
    ...
    if args['noremprec']:
        _update(settings, 'input',  'remove_precursor', 'no')
    if args['outallcandidates']:
        _update(settings, 'scoring',  'outallcandidates', 'yes')
